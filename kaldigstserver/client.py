    ...
    def opened(self):
        ...
        def send_data_to_ws():
            ...
            with self.audiofile as audiostream:
                for block in iter(lambda: audiostream.read(self.byterate/2), ""):
...
def main():
    ...
    parser.add_argument('-u', '--uri', default="wss://localhost:9004/client/ws/speech", dest="uri", help="Server websocket URI")
